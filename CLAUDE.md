...
/preset อธิบาย mutex vs semaphore          → recommends instruct-reasoning
...
> After changing `PRESET` in `.env`, restart Claude Code (`./claude_ollama.sh`) to regenerate the config.
